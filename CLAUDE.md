...
- `.github/workflows/autobump.yaml` — weekly workflow (cron `0 14 * * 3`, Wednesday 9am EST), one matrix job per owner, runs `./autobump run --config` against the rendered single-owner config
